...
function AdminOrders() {
    ...
    useEffect(() => {
        async function orderData() {
            await axios.get(`https://e-commerce-backend-e13o.onrender.com/order/fetch-all`)
                .then((res) => {
    ...
    async function handleStatus(status,itemId)
    {
        ...
        await axios.post(`https://e-commerce-backend-e13o.onrender.com/order/update/${itemId}`,{status:status})
        .then((res)=>{
            console.log(res.data);
            setStatusVar(false)
        })
